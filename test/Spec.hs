...
testColisoesParede = test
    [ "Teste com personagem dentro dos limites sem estar em plataforma" ~: do
        ...
        let mapa = mapa1
        let personagem = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(2,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
    ...
    , "Teste com personagem fora dos limites laterais" ~: do
        ...
        let mapa = mapa1
        let personagem = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(30,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
    ...
    , "Teste com personagem acima do limite superior" ~: do
        ...
        let mapa = mapa1
        let personagem = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(2,-5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
    ...
    , "Teste dentro dos limites mas a tocar numa plataforma" ~: do
        ...
        let mapa = mapa1
        let personagem = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(2,19),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
...
testColisoesPersonagem = test
    ["Teste para testar colisão entre dois personagens" ~: do
        ...
        let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(2,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
        let personagem2 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(3,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
    ...
    ,"Teste para testar se ao dois personagens não estarem a colidir a função devolde False " ~: do
        ...
        let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(2,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
        let personagem2 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(6,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
...
testvalida = test
    [
        "Teste para confirmar se o jogo foi validado" ~: do
            ...
            let listaInimigos1 = [(Personagem {direcao = Oeste, escudo = (False , 0),impulsao = False , emEscada = False, posicao = (10.5,22.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, velocidade = (0,0),vida = 1,aplicaDano = (False,0), pontos = 0}),(Personagem {posicao = (1.5,2.5),impulsao = False,escudo = (False , 0) , tamanho = (1,1), ressalta = True,tipo = Fantasma, vida = 1,aplicaDano = (False,0), pontos = 0,velocidade = (0,0),direcao = Este , emEscada = False})]
        ...
        ,"Teste para confirmar se o jogo não é validado quando só tem um fantasma" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(2,3),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
            let colecionaveis1 = [(Martelo,(3,2))]
            let listaInimigos1 = [(Personagem {direcao = Oeste, escudo = (False , 0),impulsao = False , emEscada = False, posicao = (10.5,22.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, velocidade = (0,0),vida = 1,aplicaDano = (False,0), pontos = 0})]
            let jogo1 = Jogo {mapa = mapa1, jogador = personagem1, colecionaveis = colecionaveis1, inimigos = listaInimigos1}
        ...
        ,"Teste para confirmar se o jogo não é validado quando um jogador nasce no mesmo sitio que outro personagem" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(1.5,22.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
            let colecionaveis1 = [(Martelo,(3,2))]
            let listaInimigos1 = [(Personagem {direcao = Oeste, escudo = (False , 0),impulsao = False , emEscada = False, posicao = (1.5,22.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, velocidade = (0,0),vida = 1,aplicaDano = (False,0), pontos = 0}),(Personagem {posicao = (1.5,2.5),impulsao = False,escudo = (False , 0) , tamanho = (1,1), ressalta = True,tipo = Fantasma, vida = 1,aplicaDano = (False,0), pontos = 0,velocidade = (0,0),direcao = Este , emEscada = False})]
            let jogo1 = Jogo {mapa = mapa1, jogador = personagem1, colecionaveis = colecionaveis1, inimigos = listaInimigos1}
        ...
        ,"Teste para confirmar se o jogo não é validado quando um personagem ou um colecionável nasce dentro de um bloco" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(5,23),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
...
testemovimenta = test
    [
        "Teste para confirmar se a funçao faz com que o inimigo perca um de vida em contacto com o jogador" ~: do
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(1,22.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (True,10), pontos = 0}
            let listaInimigos1 = [(Personagem {direcao = Oeste, escudo = (False , 0),impulsao = False , emEscada = False, posicao = (1,22.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, velocidade = (0,0),vida = 5,aplicaDano = (False,0), pontos = 0}),(Personagem {posicao = (2,22.5),impulsao = False,escudo = (False , 0) , tamanho = (1,1), ressalta = True,tipo = Fantasma, vida = 5,aplicaDano = (False,0), pontos = 0,velocidade = (0,0),direcao = Este , emEscada = False})]
            let colecionaveis1 = [(Martelo,(3,2))]
            let jogo1 = Jogo {mapa = mapa1, jogador = personagem1, colecionaveis = colecionaveis1, inimigos = listaInimigos1}
        ...
        ,"Teste para confirmar se a funçao faz com que o jogador a obter o martelo ganha as habilidades do mesmo" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (4,0),posicao =(1,22.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
        ...
        ,"Teste para confirmar se a funçao faz com que o jogador não caia quando está na escada" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = True, velocidade = (0,0),posicao =(2.5,8),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
        ...
        ,"Teste para confirmar se a funçao impede que o jogador saia fora dos limites do mapa" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = True, velocidade = (-1,0),posicao =(0.5,22.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
        ...
        ,"Teste para confirmar se a funçao faz com que os fantasmas não consigam ativar as plataformas mas o jogador sim" ~: do
            ...
            let listaInimigos1 = [(Personagem {direcao = Oeste, escudo = (False , 0),impulsao = False , emEscada = False, posicao = (7,10.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, velocidade = (0,0),vida = 5,aplicaDano = (False,0), pontos = 0}),(Personagem {posicao = (2,22.5),impulsao = False,escudo = (False , 0) , tamanho = (1,1), ressalta = True,tipo = Fantasma, vida = 5,aplicaDano = (False,0), pontos = 0,velocidade = (0,0),direcao = Este , emEscada = False})]
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (0,0),posicao =(9,10.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
        ...
        ,"Teste para confirmar se a funçao faz com que o jogador ganhe pontos a recolher uma moeda" ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (0,0),posicao =(1,22.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
         ...
         ,"Teste para confirmar se a funçao faz com que o jogador seja afetado pela gravidade " ~: do
            ...
            let personagem1 = Personagem{direcao = Este,impulsao = False, escudo = (False , 0) , emEscada = False, velocidade = (0,0),posicao =(2,20.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
            let jogo1 = Jogo {mapa = mapa1, jogador = personagem1, colecionaveis = [], inimigos = []}
...
testAtualiza = test
 [
    ...
    ,"Teste para confirmar se o jogador ganha velocidade em Y negativa ao subir uma escada" ~: do
        ...
        let personagem1 = Personagem {direcao = Este , impulsao = False,escudo = (False,0), emEscada = True, velocidade = (0,0),posicao =(7.5,22.5),tamanho = (1,1), ressalta = False, tipo = Jogador, vida = 50, aplicaDano = (False,0), pontos = 0}
        let jogo1 = Jogo {mapa = mapa1, jogador = personagem1, colecionaveis = [], inimigos = []}
