...
import Data.List
import LI12324 
import LI12324 (Personagem(Personagem))
...
testvalida = test
    [
        ...
        ,"Teste para confirmar se o jogo não é validado quando um jogador nasce no mesmo sitio que outro personagem" ~: do
            ...
            let personagem1 = Personagem {tamanho = (1,1), ressalta = False, tipo = Jogador}
            let colecionaveis1 = [(Martelo,(3,2))]
            let listaInimigos = [(Personagem {posicao = (1.5,15.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, vida = 1}),(Personagem {posicao = (1.5,22.5), tamanho = (1,1), ressalta = True,tipo = Fantasma, vida = 1})]
            let jogo1 = Jogo {mapa = mapa1, jogador = personagem1, colecionaveis = colecionaveis1, inimigos = listaInimigos}
...
testemovimenta = test
    [
        ...
        ,"Teste para confirmar se a funçao faz com que o jogador a obter o martelo ganha as habilidades do mesmo" ~: do
            ...
            assertEqual "O jogo a movimentar corretamente" True  ((fst . aplicaDano . jogador. movimenta 100 1 $ jogo1) == True)
